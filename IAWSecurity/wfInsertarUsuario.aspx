<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="wfInsertarUsuario.aspx.cs" Inherits="IAWSecurity.wfInsertarUsuario" %>
            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <asp:Button ID="Button1" runat="server" Text="Guardar" CssClass="btn btn-primary" ValidationGroup="User" OnClick="btnSave_Click"/>
